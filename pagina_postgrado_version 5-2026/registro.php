...
<head>
    ...
    <link rel="icon" href="assets/imagenes/sip.ico">
</head>
<body>
    ...
    <header class="navbar-header">
        <div class="header-content">
            <div class="logo-container">
                <img src="assets/imagenes/LOGO-1-1.png" alt="Logo UNEFA" class="logo-img">
            </div>
...
$form_action_registro = app_url('includes/procesar_registro.php');
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="<?= htmlspecialchars(app_url('assets/css/style-registro.css'), ENT_QUOTES, 'UTF-8') ?>">
    <link rel="icon" href="<?= htmlspecialchars(app_url('assets/imagenes/sip.ico'), ENT_QUOTES, 'UTF-8') ?>">
</head>
<body>
    ...
    <header class="navbar-header">
        <div class="header-content">
            <div class="logo-container">
                <img src="<?= htmlspecialchars(app_url('assets/imagenes/LOGO-1-1.png'), ENT_QUOTES, 'UTF-8') ?>" alt="Logo UNEFA" class="logo-img">
            </div>
            <div class="nav-buttons">
                <a href="<?= htmlspecialchars(app_url('Inicio.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn-primary">Inicio de Sesión</a>
                <a href="<?= htmlspecialchars(app_url('registro.php'), ENT_QUOTES, 'UTF-8') ?>" class="btn-outline active">Registro</a>
            </div>
        </div>
    </header>
    ...
    <main class="main-container">
        ...
        <section class="registration-card">
            <div id="registro-mensaje" role="alert" style="display:none;margin-bottom:16px;padding:12px 14px;border-radius:8px;border:1px solid #b91c1c;background:#fee2e2;color:#7f1d1d;font-size:0.9rem;"></div>
            <form id="multi-step-form" action="<?= htmlspecialchars($form_action_registro, ENT_QUOTES, 'UTF-8') ?>" method="POST" data-registro-ajax="1">
                ...
                <div class="form-step active" id="step-1">
                    ...
                    <div class="form-grid-2" style="margin-top: 16px;">
                        <div class="input-group">
                            <label>Primer nombre:</label>
                            <input type="text" name="primerNombre" id="primerNombre" placeholder="Tu primer nombre" required>
                        </div>
                        <div class="input-group">
                            <label>Segundo nombre:</label>
                            <input type="text" name="segundoNombre" id="segundoNombre" placeholder="Opcional">
                        </div>
                        <div class="input-group">
                            <label>Primer apellido:</label>
                            <input type="text" name="primerApellido" id="primerApellido" placeholder="Tu primer apellido" required>
                        </div>
                        <div class="input-group">
                            <label>Segundo apellido:</label>
                            <input type="text" name="segundoApellido" id="segundoApellido" placeholder="Tu segundo apellido" required>
                        </div>
                        <div class="input-group full" style="grid-column: 1 / -1;">
                            <label>Correo electrónico:</label>
                            <input type="email" name="email" id="email_registro" placeholder="tu.correo@ejemplo.com" required>
                        </div>
                    </div>
    ...
    <script src="<?= htmlspecialchars(app_url('assets/js/multi-step-form.js'), ENT_QUOTES, 'UTF-8') ?>"></script>
</body>
</html>  
